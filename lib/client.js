    ...
    async.mapLimit(pointers, limit, function(pointer, done) {
      ...
      client.onopen = function() {
        ...
        client.onmessage = function(e) {
          var isBlob = typeof Blob !== 'undefined' && e.data instanceof Blob;
          var json;

          if (!Buffer.isBuffer(e.data) && !isBlob) {
            try {
            ...
            if (json.code && json.code !== 200) {
              return emitter.emit('error', new Error(json.message));
            }
          }

          emitter.emit('data', e.data);
        };
