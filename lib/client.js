 ...
 * @returns {Promise}
 */
Client.prototype.getContactList = function(options) {
  return this._request('GET', '/contacts', options || {});
};
 ...
 * @returns {Promise}
 */
Client.prototype.getContactByNodeId = function(nodeId) {
  return this._request('GET', '/contacts/' + nodeId, {});
};
